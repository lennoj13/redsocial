            ...
            <div class="post">
                ...
                <?php if ($username === $_SESSION['user_data']['username']): ?>
                    <form action="delete_post.php" method="post" style="display: inline;">
                        ...
                        <input type="submit" value="Eliminar Publicación" style="display: none;">
                        <a href="#" onclick="this.previousElementSibling.click();" style="float: right; text-decoration: underline; cursor: pointer;">Eliminar Publicación</a>
                    </form>
                <?php endif; ?>
            </div>
        <?php endwhile; ?>
